...
function fractalcheckboxGUI(){
    ...
    if(randomangles[0])
    {
        document.getElementById("fractalrandomangmin").style.visibility = "visible";
        document.getElementById("fractalrandomangmax").style.visibility = "visible";
        document.getElementById("fractalrandomangminlabel").style.visibility = "visible";
        document.getElementById("fractalrandomangmaxlabel").style.visibility = "visible";

    }
    else
    {
        document.getElementById("fractalrandomangmin").style.visibility = "hidden";
        document.getElementById("fractalrandomangmax").style.visibility = "hidden";
        document.getElementById("fractalrandomangminlabel").style.visibility = "hidden";
        document.getElementById("fractalrandomangmaxlabel").style.visibility = "hidden";
    }
